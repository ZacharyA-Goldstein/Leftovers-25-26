...
public class autoCloseBlue extends OpMode {
    ...
    org.firstinspires.ftc.teamcode.auton.autoCloseBlue.PathState pathState;
    ...
    public void StatePathUpdate(){
        switch(pathState){
            ...
            case intakeOn:
                if(!follower.isBusy()){
                    intakeOn();
                    setPathState(org.firstinspires.ftc.teamcode.auton.autoCloseBlue.PathState.StartIntake1Pos_FinishIntake1Pos);
                }
                break;
            ...
            case intakeOff:
                if(!follower.isBusy()){
                    intakeOff();
                    setPathState(org.firstinspires.ftc.teamcode.auton.autoCloseBlue.PathState.FinishIntake1Pos_ShootPos2);
                }
                break;
    ...
    public void init(){
        ...
        pathState= org.firstinspires.ftc.teamcode.auton.autoCloseBlue.PathState.startPos_ShootPos;
        pathTimer=new Timer();
